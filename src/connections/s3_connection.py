...
class s3_operations:
    ...
    def fetch_file_from_s3(self, file_key):
        ...
        try:
            ...
            logging.info(f"Successfully fetched and loaded '{file_key}' from S3 bucket that has {len(df)} records.")
            return df
