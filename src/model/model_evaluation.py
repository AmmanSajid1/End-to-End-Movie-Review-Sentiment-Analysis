...
def main():
    ...
    with mlflow.start_run() as run:  # Start an MLflow run
        try:
            ...
            X_test = scipy.sparse.load_npz('./data/processed/test_tfidf.npz')
            y_test = pd.read_csv('./data/processed/test_labels.csv')['label'].values
            ...
            if hasattr(clf, 'get_params'):
                ...
                mlflow.log_param("max_features", X_test.shape[1])
