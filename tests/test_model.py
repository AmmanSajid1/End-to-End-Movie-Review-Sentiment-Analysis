...
class TestModelLoading(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.X_test = scipy.sparse.load_npz('./data/processed/test_tfidf.npz')
        cls.y_test = pd.read_csv('./data/processed/test_labels.csv')['label'].values
    ...
    def test_model_performance(self):
        ...
        y_pred_new = self.new_model.predict(self.X_test)
        ...
        f1_new = f1_score(self.X_test, y_pred_new)
